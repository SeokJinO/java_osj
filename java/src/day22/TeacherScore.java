...
public class TeacherScore {
	...
	public TeacherScore(int grade, int term, String name, int midterm, int finals, int performanceAssessment) {
	...
	public TeacherScore(int grade, int term, String name) {
		setGrade(grade);
		setTerm(term);
		this.name = name;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TeacherScore other = (TeacherScore) obj;
