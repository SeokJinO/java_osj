...
public class BoardController {
	...
	public ModelAndView boardSelectGet(ModelAndView mv, @PathVariable("bd_num") int bd_num, HttpSession session) {
	...
	public ModelAndView boardUpdatePost(ModelAndView mv, @PathVariable("bd_num") int bd_num, BoardVO board, HttpSession session, MultipartFile[] files,
			int[] nums) {
		MemberVO user = (MemberVO) session.getAttribute("user");
	...
	public ModelAndView boardDeleteGet(ModelAndView mv, @PathVariable("bd_num") int bd_num, HttpSession session) {
		MemberVO user = (MemberVO) session.getAttribute("user");
	...
	@ResponseBody
	public Map<Object, Object> checkLikse(@RequestBody LikesVO likes, HttpSession session) {
