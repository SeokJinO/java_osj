...
<div class="container">
	...
	<div class="form-group">
		<form class="input-group">
			<select class="input-group-prepend form-control col-2"
				name="searchType">
				<option value="all">전체</option>
				<option value="bd_title">제목</option>
				<option value="bd_me_id">작성자</option>
			</select> <input type="text" class="form-control col-8" name="search"
				value="${pm.cri.search}">
	...
	<table class="table table-striped table-hover">
		<thead>
			<tr>
				<th class="title"><span>번호</span> <span class="sort down"
					data-target="bd_num"> <i class="fa-solid fa-sort-up"></i> <i
						class="fa-solid fa-sort-down"></i>
				</span></th>
				<th class="title"><span>제목</span> <span class="sort"
					data-target="bd_title"> <i class="fa-solid fa-sort-up"></i>
						<i class="fa-solid fa-sort-down"></i>
				</span></th>
				<th class="title"><span>작성자</span> <span class="sort"
					data-target="bd_me_id"> <i class="fa-solid fa-sort-up"></i>
						<i class="fa-solid fa-sort-down"></i>
				</span></th>
				<th><span>작성일</span> <span class="sort"> <i
						class="fa-solid fa-sort-up"></i> <i class="fa-solid fa-sort-down"></i>
				</span></th>
				<th class="title"><span>조회수</span> <span class="sort"
					data-target="bd_views"> <i class="fa-solid fa-sort-up"></i>
						<i class="fa-solid fa-sort-down"></i>
				</span></th>
				<th><span>추천</span> <span class="sort"> <i
						class="fa-solid fa-sort-up"></i> <i class="fa-solid fa-sort-down"></i>
				</span></th>
			</tr>
		</thead>
